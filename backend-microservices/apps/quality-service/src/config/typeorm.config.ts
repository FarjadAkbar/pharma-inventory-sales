...
import { QCTest, QCTestSpecification, QCSample, QCResult } from '../entities';
import { QARelease, QAChecklistItem, QADeviation } from '../entities';
import * as dotenv from 'dotenv';

dotenv.config();

const ENTITIES = [QCTest, QCTestSpecification, QCSample, QCResult, QARelease, QAChecklistItem, QADeviation];
