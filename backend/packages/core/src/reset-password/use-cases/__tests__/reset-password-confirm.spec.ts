...
import { IConfirmResetPasswordAdapter } from '@pharma/services/auth-service/src/adapters';
import { ApiBadRequestException, ApiNotFoundException, ApiUnauthorizedException } from '@pharma/utils/exception';
