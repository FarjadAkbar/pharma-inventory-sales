...
export default function StoresPage() {
  ...
  return (
    <DashboardLayout>
      <PermissionGuard permissions={["view_stores"]} fallback={<div className="p-4">Access denied</div>}>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle>Stores</CardTitle>
            <PermissionGuard permissions={["create_stores", "edit_stores"]} requireAll={false}>
            ...
            <DataTable
              ...
              actions={(row: any) => (
                <div className="flex gap-2">
                  <PermissionGuard permissions={["edit_stores"]}>
                    <Button variant="outline" size="sm" onClick={() => onEdit(row)}>
                      Edit
                    </Button>
                  </PermissionGuard>
                  <PermissionGuard permissions={["delete_stores"]}>
